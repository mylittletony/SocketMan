...
/*   // Problem on Debian! */
/*   /1* if (iw->txpower(interface, &txpower)) { *1/ */
/*   /1*   json_object *jtxpower = json_object_new_int(txpower); *1/ */
/*   /1*   json_object_object_add(jssids, "txpower", jtxpower); *1/ */
/*   /1* } *1/ */

/*   // Not complete */
/*   /1* if (iw->encryption(interface, encryption)) { *1/ */
/*   /1*   json_object *jencryption = json_object_new_string(encryption); *1/ */
/*   /1*   json_object_object_add(*jssids, "encryption", jencryption); *1/ */
/*   /1* } *1/ */
/* } */
