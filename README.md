...
A light-weight daemon, written purely in c, that runs on most OpenWRT, LEDE and other \*nix devices. SocketMan is used at CT WiFi (formally known as Cucumber Tony) to control their global estate of access points and routers.
